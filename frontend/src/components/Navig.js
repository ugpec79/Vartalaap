...
export const Navig = () => {
  return (
    <div className='flex flex-row justify-center bg-none py-1'>
        ...
        <Link href='/Facilities'><div className='px-10 text-xl bg-transparent hover:bg-gradient-to-r from-sky-500 to-indigo-500 hover:text-white hover:rounded-full p-5'><button>Create a Blog!</button></div></Link>
        <Link href='/Service'><div className='px-10 text-xl bg-transparent hover:bg-gradient-to-r from-sky-500 to-indigo-500 hover:text-white hover:rounded-full p-5'><button>All Blogs</button></div></Link>
